 ...
 * 2016-09-14T15:57:11.566-05:00
 * Generated source version: 2.7.3
 * 
 */
@WebServiceClient(name = "CreditScoreService", 
                  wsdlLocation = "file:/C:/BCJMAY16/Develop/Work%20Space/last/CreditScoreAccessor/src/main/resources/test.wsdl",
...
public class CreditScoreService_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/BCJMAY16/Develop/Work%20Space/last/CreditScoreAccessor/src/main/resources/test.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CreditScoreService_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/BCJMAY16/Develop/Work%20Space/last/CreditScoreAccessor/src/main/resources/test.wsdl");
        }
        WSDL_LOCATION = url;
    }
