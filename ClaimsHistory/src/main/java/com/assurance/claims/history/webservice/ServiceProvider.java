 ...
 * 2016-09-15T16:10:09.165-05:00
 * Generated source version: 2.7.3
 * 
 */
@WebServiceClient(name = "ServiceProvider", 
                  wsdlLocation = "file:/C:/BCJ-May16/Development/Workspace/Assurance/ClaimsHistory/src/main/resources/ClaimHistory.wsdl",
...
public class ServiceProvider extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/BCJ-May16/Development/Workspace/Assurance/ClaimsHistory/src/main/resources/ClaimHistory.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ServiceProvider.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/BCJ-May16/Development/Workspace/Assurance/ClaimsHistory/src/main/resources/ClaimHistory.wsdl");
        }
        WSDL_LOCATION = url;
    }
